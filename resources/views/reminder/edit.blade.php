            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Update Reminder</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('reminder.index') }}">Reminders</a>
                                    </li>
                                    <li class="breadcrumb-item active">Update Reminder
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    <form action="{{ route('reminder.update',$reminder) }}" method="POST" id="update_form" name="update_form">
                                        @method('patch')
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
        ...
        $(document).ready(function() {
            ...
            $("#update_form").validate({
                ...
                submitHandler: function(form) {
                    if ($("#update_form").validate().checkForm()) {
